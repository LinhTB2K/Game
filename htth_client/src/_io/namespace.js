...
export default class io_namespace extends mapView {
    ...
    createObjectIO = () => {
        ...
        // QUEST SYSTEM LISTENER
        this.ws.on('quest:update', (payload) => {
            this.my.questPayload = payload;
            // Neu tab nhiệm vụ đang bật, gọi hàm render lại
            if(this.box.children.length > 0 && this.box.name_menu === 'quester') {
                this.quester();
            }
        });
