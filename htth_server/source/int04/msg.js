...
module.exports = function(socket) {
    ...
    socket.on('quest:accept', function(questId) {
        questController.acceptQuest(socket, questId);
    });
    socket.on('quest:claim', function(questId) {
        questController.claimReward(socket, questId);
    });
    socket.on('quest:talk', function(npcId) {
        questController.updateProgress(socket, 'talk', npcId, 1);
    });
